...
contract ChaiTest is DSTest, ChaiSetup {
    ...
    function test_chai() public {
      assertEq(address(chai), address(0x3fa733B07a7cEBB28aE4da05054fbcb53eC4ee4c));
    }
...
contract TokenTest is DSTest, ChaiSetup {
    ...
    function testDomain_Separator() public {
        assertEq(chai.DOMAIN_SEPARATOR(), 0x9e181843763782d3938b68be3f5e957c1fe62ef2b84b0669f36a91214edb4806);
    }
